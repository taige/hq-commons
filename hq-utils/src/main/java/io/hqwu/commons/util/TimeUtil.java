...
public final class TimeUtil extends DateUtils {
    ...
    public static final String getCurrentTimeString(String pattern) {
        if (StringUtils.isBlank(pattern)) {// 默认处理
     ...
     * @param srcDate 原日期
     * @param pattern 日期格式
     * @param offset  偏移量，正数表示后移，负数表示前移
     * @return 日期偏移后的格式化字符串
     */
     ...
     * 当前线程休眠指定时间，单位：毫秒
     *
     * @param milliSec 休眠毫秒数
     * @param info     休眠原因，不为空者日志输出
     */
    ...
    public static Map<String, String> SUPPORT_TIMEZONE = new HashMap<String, String>();

    static {
        SUPPORT_TIMEZONE.put("GMT", "GMT");
        SUPPORT_TIMEZONE.put("GMT+0", "GMT+0");
        SUPPORT_TIMEZONE.put("GMT+1", "GMT+1");
        SUPPORT_TIMEZONE.put("GMT+10", "GMT+10");
        SUPPORT_TIMEZONE.put("GMT+11", "GMT+11");
        SUPPORT_TIMEZONE.put("GMT+12", "GMT+12");
        SUPPORT_TIMEZONE.put("GMT+2", "GMT+2");
        SUPPORT_TIMEZONE.put("GMT+3", "GMT+3");
        SUPPORT_TIMEZONE.put("GMT+4", "GMT+4");
        SUPPORT_TIMEZONE.put("GMT+5", "GMT+5");
        SUPPORT_TIMEZONE.put("GMT+6", "GMT+6");
        SUPPORT_TIMEZONE.put("GMT+7", "GMT+7");
        SUPPORT_TIMEZONE.put("GMT+8", "GMT+8");
        SUPPORT_TIMEZONE.put("GMT+9", "GMT+9");
        SUPPORT_TIMEZONE.put("GMT-0", "GMT-0");
        SUPPORT_TIMEZONE.put("GMT-1", "GMT-1");
        SUPPORT_TIMEZONE.put("GMT-10", "GMT-10");
        SUPPORT_TIMEZONE.put("GMT-11", "GMT-11");
        SUPPORT_TIMEZONE.put("GMT-12", "GMT-12");
        SUPPORT_TIMEZONE.put("GMT-13", "GMT-13");
        SUPPORT_TIMEZONE.put("GMT-14", "GMT-14");
        SUPPORT_TIMEZONE.put("GMT-2", "GMT-2");
        SUPPORT_TIMEZONE.put("GMT-3", "GMT-3");
        SUPPORT_TIMEZONE.put("GMT-4", "GMT-4");
        SUPPORT_TIMEZONE.put("GMT-5", "GMT-5");
        ...
        SUPPORT_TIMEZONE.put("GMT-8", "GMT-8");
        SUPPORT_TIMEZONE.put("GMT-9", "GMT-9");
        SUPPORT_TIMEZONE.put("GMT0", "GMT0");
    }

    public static boolean isSupportTimeZone(String timeZoneId) {
        return SUPPORT_TIMEZONE.containsKey(timeZoneId);
    }
     ...
     * @return 当前日期yyyyMMdd格式字符串
     */
    public static final String getCurrentDate14(String timeZoneId) {
        return getCurrentTimeString(PATTERN_YYYYMMDDHHMMSS, timeZoneId);
    }
     ...
     * @return 当前日期yyyyMMdd格式字符串
     */
    public static final String getCurrentDate8(String timeZoneId) {
        return getCurrentTimeString(PATTERN_YYYYMMDD, timeZoneId);
    }
     ...
     * @return 当前日期时间HHmmss格式字符串
     */
    public static final String getCurrentTime6(String timeZoneId) {
        return getCurrentTimeString(PATTERN_HHMMSS, timeZoneId);
    }
     ...
     * @return 当前日期yyyyMMdd格式字符串
     */
    public static final String getDate14(long epochMilli, String timeZoneId) {
        return getTimeString(epochMilli, PATTERN_YYYYMMDDHHMMSS, timeZoneId);
    }
     ...
     * @return 当前日期yyyyMMdd格式字符串
     */
    public static final String getDate8(long epochMilli, String timeZoneId) {
        return getTimeString(epochMilli, PATTERN_YYYYMMDD, timeZoneId);
    }
     ...
     * @return 当前日期时间HHmmss格式字符串
     */
    public static final String getTime6(long epochMilli, String timeZoneId) {
        return getTimeString(epochMilli, PATTERN_HHMMSS, timeZoneId);
    }
     ...
     * @return 当前日期yyMMdd格式字符串
     */
    public static final String getCurrentDate6(String timeZoneId) {
        return getCurrentTimeString(PATTERN_YYMMDD, timeZoneId);
    }
     ...
     * @return 表示当前系统日期时间的格式化字符串
     */
    public static final String getCurrentTimeString(String pattern, String timeZoneId) {
        return getTimeString(System.currentTimeMillis(), pattern, timeZoneId);
    }
     ...
     * @return 表示当前系统日期时间的格式化字符串
     */
    public static final String getTimeString(long epochMilli, String pattern, String timeZoneId) {
        if (StringUtils.isBlank(pattern)) {// 默认处理
            pattern = PATTERN_YYYYMMDDHHMMSS;
        }
        TimeZone timeZone = TimeZone.getTimeZone(timeZoneId);
        return DateFormatUtils.format(epochMilli, pattern, timeZone);
    }
